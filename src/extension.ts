...
import { GENERATE_CLASS_DATA, UPDATE_CLASS_DATA } from './editors';
...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand(UPDATE_CLASS_DATA, () => dartCodeActionProvider.code.data?.updateChanges())
	);

	context.subscriptions.push(
		vscode.commands.registerCommand(GENERATE_CLASS_DATA, () => dartCodeActionProvider.code.data?.insertAll())
	);
